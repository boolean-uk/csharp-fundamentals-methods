...
namespace csharp_fundamentals_methods.Main
{
    public class Core
    {
        ...
        // or we can do: return Enumerable.Range(lower, upper - lower + 1).ToArray();
        // https://learn.microsoft.com/en-us/dotnet/api/system.linq.enumerable.range?view=net-7.0  this documentation
        ...
        {
            string shout = phrase.ToUpper() + new string('!', number);
            return shout;
        }
